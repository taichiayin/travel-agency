<template>
  <section class="relative p-20 bg-[url('@/assets/images/packages/bottomBg.jpg')] bg-center bg-no-repeat bg-cover bg-fixed">
    <div class="absolute top-0 left-0 right-0 bottom-0 w-full h-full bg-gray-800 opacity-50"></div>
    <div class="w-[1200px] mx-auto p-4 relative z-10">
      <div class="w-3/5">
        <div class="mb-6 text-sm font-medium text-white tracking-wide">HOLIDAY PACKAGE OFFER</div>
        <h2 class="mb-6 text-4xl font-bold text-white tracking-wider">HOLIDAY SPECIAL <span class="font-['Raleway']">25%</span> OFF</h2>
